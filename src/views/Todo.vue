<template>
  <div class="todo">
    <h3>ToDo list</h3>
    <p>Kirjuta üles, mis tarvis ära teha. Linnuke sellele, mis juba tehtud</p>
    <div class="container">
      <div style="flex: 1;">
        ...
        <div class="input__div">
          <div class="input__wrapper">
            <input type="text" 
            placeholder="Lisa uus" v-model="newTodo"
            @keyup.enter="addTodo" />
          </div>
        ...
        <div v-for="todo in todos" :key="todo.id" class="list">
          ...
          v-if="!todo.editing" @dblclick="todo.editing = true; 
          editTodoCache=todo.text">{{ todo.text }}
          </div>
          
          <div class="input__div" v-else>
            <div class="input__wrapper">
              <input type="text" v-focus v-model="todo.text" @keyup.enter="editTodo(todo)"
              @keyup.esc="cancelEdit(todo)" @blur="cancelEdit(todo)" />
            </div>
            <div class="border"></div>
          </div>
